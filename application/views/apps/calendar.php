...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url ('assets/vendors/fullcalendar/main.min.css'); ?>">
			...
			<nav class="navbar">
              ...
              <div class="input-group-text">
                ...
                <div class="row g-0 p-1">
                  ...
                  <div class="col-3 text-center">
                    <a href="<?php echo base_url ('apps/calendar'); ?>" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="calendar" class="icon-lg mb-1"></i><p class="tx-12">Calendar</p></a>
                  </div>
                  <div class="col-3 text-center">

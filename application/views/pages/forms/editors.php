...
<head>
  ...
  <!-- End fonts -->
	...
	<link rel="stylesheet" href="<?php echo base_url ('assets/vendors/easymde/easymde.min.css');?>">
...
class Alert {
  ...
  <script src="<?php echo base_url ('assets/vendors/tinymce/tinymce.min.js');?>"></script>
	<script src="<?php echo base_url ('assets/vendors/easymde/easymde.min.js');?>"></script>
  ...
  <script src="<?php echo base_url ('assets/js/tinymce.js');?>"></script>
	<script src="<?php echo base_url ('assets/js/easymde.js');?>"></script>

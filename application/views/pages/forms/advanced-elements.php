...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url ('assets/vendors/select2/select2.min.css'); ?>">
	...
	<link rel="stylesheet" href="<?php echo base_url ('assets/vendors/pickr/themes/classic.min.css'); ?>">
...
<body>
  ...
  <script src="<?php echo base_url ('assets/vendors/jquery-validation/jquery.validate.min.js'); ?>"></script>
	...
	<script src="<?php echo base_url ('assets/vendors/pickr/pickr.min.js'); ?>"></script>
  ...
  <script src="<?php echo base_url ('assets/js/form-validation.js');?>"></script>
	...
	<script src="<?php echo base_url ('assets/js/pickr.js');?>"></script>

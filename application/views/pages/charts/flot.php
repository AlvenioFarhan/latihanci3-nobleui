...
<body>
  ...
  <script src="<?php echo base_url ('assets/vendors/jquery.flot/jquery.flot.categories.js');?>"></script>
  ...
  <script src="<?php echo base_url ('assets/js/jquery.flot-light.js');?>"></script>

...
<body>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div>
                      <img src="<?php echo base_url ('assets/images/photos/img1.jpg'); ?>" class="w-100" id="croppingImage" alt="cropper">
                    </div>
  ...
  <script src="<?php echo base_url ('assets/vendors/cropperjs/cropper.min.js'); ?>"></script>

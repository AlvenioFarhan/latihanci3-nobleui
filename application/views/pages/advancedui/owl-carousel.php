...
<body>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="owl-carousel owl-theme owl-basic">
                  ...
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img2.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img3.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img4.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img5.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img6.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img7.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img8.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img9.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img10.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img11.jpg'); ?>" alt="item-image">
                  </div>
                  <div class="item">
                    <img src="<?php echo base_url ('assets/images/photos/img12.jpg'); ?>" alt="item-image">
                  </div>
                </div>
              </div>
            </div>
  ...
  <script src="<?php echo base_url ('assets/vendors/jquery-mousewheel/jquery.mousewheel.js'); ?>"></script>

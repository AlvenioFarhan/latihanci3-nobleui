            ...
            <div class="example">
							...
							<nav class="navbar navbar-light bg-light">
								<a class="navbar-brand" href="javascript:;">
									<img src="<?php echo base_url ('assets/images/others/logo-placeholder.png'); ?>" width="30" height="30" alt="">
								</a>
							</nav>
						</div>
	...
	<a class="navbar-brand" href="#">
		<img src="..." width="30" height="30" alt="">
						...
						<div class="example">
							...
							<nav class="navbar navbar-light bg-light">
									<a class="navbar-brand" href="javascript:;">
										<img src="<?php echo base_url ('assets/images/others/logo-placeholder.png'); ?>" width="30" height="30" class="d-inline-block align-top" alt="">
										Logo
									</a>
								</nav>
						</div>

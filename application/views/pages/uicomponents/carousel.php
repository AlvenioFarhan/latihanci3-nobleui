							...
							<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img src="<?php echo base_url ('assets/images/photos/img10.jpg'); ?>" class="d-block w-100" alt="...">
									</div>
									<div class="carousel-item">
										<img src="<?php echo base_url ('assets/images/photos/img11.jpg'); ?>" class="d-block w-100" alt="...">
									</div>
									<div class="carousel-item">
										<img src="<?php echo base_url ('assets/images/photos/img15.jpg'); ?>" class="d-block w-100" alt="...">
									</div>
								</div>
							</div>
						</div>

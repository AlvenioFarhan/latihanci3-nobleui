			...
			<div class="page-content">
              ...
              <div class="row">
                <div class="col-12 col-md-6 col-xl-4">
                  <div class="card">
                      <img src="<?php echo base_url ('assets/images/others/placeholder.jpg'); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  <div class="card text-white">
                    <img src="<?php echo base_url ('assets/images/others/placeholder.jpg'); ?>" class="card-img" alt="...">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">Last updated 3 mins ago</p>
            ...
            <h4 id="bg-color">Background Color</h4>
						<p class="mb-3">Use <a href="<?php echo base_url ('https://getbootstrap.com/docs/5.1/utilities/colors/'); ?>" target="_blank">text color</a> and <a href="<?php echo base_url ('https://getbootstrap.com/docs/5.1/utilities/background/'); ?>" target="_blank">background utilities</a> to change the appearance of a card.</p>
						<div class="example">
              <div class="row">

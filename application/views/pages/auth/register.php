...
<!-- Mirrored from www.nobleui.com/html/template/demo1/pages/auth/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Jun 2023 11:56:18 GMT -->
<head>
	<meta charset="UTF-8">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample">
                      ...
                      <div>
                        <a href="<?php echo base_url (); ?>" class="btn btn-primary text-white me-2 mb-2 mb-md-0">Sign up</a>
                        <button type="button" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">
                          <i class="btn-icon-prepend" data-feather="twitter"></i>
                          Sign up with twitter
                        </button>
                      </div>
                      <a href="<?php echo base_url ('auth/login'); ?>" class="d-block mt-3 text-muted">Already a user? Sign in</a>
                    </form>
                  </div>
                </div>
              </div>
